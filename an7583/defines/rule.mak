...
ifneq ($(strip $(TCSUPPORT_L4S)),)
export TCSUPPORT_L4S=1
BSP_CFLAGS+=-DTCSUPPORT_L4S
endif
...
ifneq ($(strip $(TCSUPPORT_NEW_SPI)),)
export TCSUPPORT_NEW_SPI=1
endif

ifneq ($(strip $(TCSUPPORT_OPTEE)),)
export TCSUPPORT_OPTEE=1
endif

ifneq ($(strip $(RDKB_BUILD)),)
export RDKB_BUILD=1
BSP_CFLAGS+=-DRDKB_BUILD
endif

ifneq ($(strip $(TCSUPPORT_ATF_RELEASE)),)
export TCSUPPORT_ATF_RELEASE
BSP_CFLAGS+=-DTCSUPPORT_ATF_RELEASE
endif

ifneq ($(strip $(TCSUPPORT_DM_VERITY)),)
export TCSUPPORT_DM_VERITY
endif

ifneq ($(strip $(TCSUPPORT_DM_CRYPT)),)
export TCSUPPORT_DM_CRYPT
BSP_CFLAGS+=-DTCSUPPORT_DM_CRYPT
endif

ifneq ($(strip $(TCSUPPORT_POWER_SAVING)),)
export TCSUPPORT_POWER_SAVING
BSP_CFLAGS+=-DTCSUPPORT_POWER_SAVING
endif

ifneq ($(strip $(TCSUPPORT_TCBOOT_1MB_SIZE)),)
export TCSUPPORT_TCBOOT_1MB_SIZE=1
BSP_CFLAGS+=-DTCSUPPORT_TCBOOT_1MB_SIZE
endif
...
#BSP_CFLAGS+=-I$(GLOBAL_INC_DIR)
#endif
#ifneq ($(strip $(VERSION_DIR)),)
#BSP_CFLAGS+=-I$(VERSION_DIR)
#endif
#ifneq ($(strip $(TOOLS_DIR)),)
#BSP_CFLAGS+=-I$(TOOLS_DIR)
#endif

export PATH_LINK=-Wl,-rpath-link,$(APP_BSP_LIB_DIR)
export COMPILEOPTION_LIB=-lcompileoption_bsp
...
#export TCSUPPORT_PWR_SENSOR=1
export CONFIG_USE_MT7520_ASIC=1
TCSUPPORT_BOOT_LZMA=1
export DTB_FILE=en7552.dtb
export DTB_WRT_FILE=en7552_evb.dtb
export DTB_EVB_FILE=
export DTB_PATH=$(KERNEL_DIR)/arch/arm/boot/dts
export DTS_FILE=en7552.dts
...
BSP_CFLAGS+= -DTCSUPPORT_CPU_AN7552
...
#BSP_CFLAGS+= -DTCSUPPORT_PWR_SENSOR
...
ifneq ($(strip $(TCSUPPORT_SWITCH_8851)),)
export TCSUPPORT_SWITCH_8851=1
BSP_CFLAGS+= -DTCSUPPORT_SWITCH_8851
endif
else #ifneq ($(strip $(TCSUPPORT_CPU_AN7552)),)
...
export TCSUPPORT_EN7581_NEON=1
# export MT7510_EN7512_FPGA_STAGE=1
export CONFIG_USE_MT7520_ASIC=1
export TCSUPPORT_MT7510_FE=1
export TCSUPPORT_MT7530_SWITCH_API=1
...
export RALINK_PCIE_ADDR_SWAP=1
export TCSUPPORT_HWNAT_WIFI=1
export TCPLATFORM=en7581
export TCSOCNAME=en7523

#export UBOOT_CONFIG=an7583
export TCSUPPORT_UBOOT_64BIT=1
#export TCSUPPORT_BB_SPI=1
#export TCSUPPORT_BB_NAND=1
export TCSUPPORT_WLAN_SW_RPS=1
export TCSUPPORT_LITTLE_ENDIAN=1
...
export TCSUPPORT_THERMAL_SENSOR=1
export TCSUPPORT_PWR_SENSOR=1
export TCSUPPORT_HIGH_SPEED_UART=1
TCSUPPORT_BOOT_LZMA=1
#export TCSUPPORT_PARALLEL_NAND=1
export TCSUPPORT_EMMC=1
#export DTB_FILE=an7583_evb.dtb
#export DTB_PATH=$(KERNEL_DIR)/arch/arm64/boot/dts/airoha/an7583
#export DTS_FILE=an7583_evb.dts

BSP_CFLAGS+=-DTCSUPPORT_EMMC
#BSP_CFLAGS+=-DTCSUPPORT_PARALLEL_NAND
BSP_CFLAGS+=-DTCSUPPORT_BOOTROM_LARGE_SIZE
BSP_CFLAGS+=-DTCSUPPORT_DDR_CALI
BSP_CFLAGS+= -DTCSUPPORT_LITTLE_ENDIAN
...
BSP_CFLAGS+= -DTCSUPPORT_CPU_EN7523
BSP_CFLAGS+= -DTCSUPPORT_CPU_EN7580
BSP_CFLAGS+= -DTCSUPPORT_CPU_EN7581
BSP_CFLAGS+= -DTCSUPPORT_CPU_AN7583
ifneq ($(strip $(TCSUPPORT_BOARD_SELECT)),)
export TCSUPPORT_BOARD_SELECT=1
BSP_CFLAGS+= -DTCSUPPORT_BOARD_SELECT
endif
BSP_CFLAGS+= -DTCSUPPORT_EN7581_NEON
BSP_CFLAGS+= -DTCSUPPORT_MT7510_FE
BSP_CFLAGS+= -DTCSUPPORT_MT7530_SWITCH_API
BSP_CFLAGS+= -DTCSUPPORT_DRIVER_API
BSP_CFLAGS+= -DTCSUPPORT_ADDR_MAPPING
BSP_CFLAGS+= -DCONFIG_USE_MT7520_ASIC
BSP_CFLAGS+= -DTCSUPPORT_UART1_ENHANCE
ifeq ($(strip $(TCSUPPORT_6_6_KERNEL)),)
BSP_CFLAGS+=-DTCSUPPORT_WLAN_SW_RPS
endif
BSP_CFLAGS+= -DTCSUPPORT_THERMAL_SENSOR
BSP_CFLAGS+= -DTCSUPPORT_PWR_SENSOR
BSP_CFLAGS+=-DTCSUPPORT_HIGH_SPEED_UART
...
ifneq ($(strip $(TCSUPPORT_ECNT_1588v2)),)
export TCSUPPORT_ECNT_1588v2=1
BSP_CFLAGS+= -DTCSUPPORT_ECNT_1588v2
endif
else #ifneq ($(strip $(TCSUPPORT_CPU_AN7583)),)
...
#export TCSUPPORT_PARALLEL_NAND=1
export TCSUPPORT_EMMC=1
#ifneq ($(strip $(TCSUPPORT_KERNEL_API)),)
#export DTB_FILE=en7581_kernel_api.dtb
#else
#export DTB_FILE=en7581.dtb
#endif
#export DTB_PATH=$(KERNEL_DIR)/arch/arm64/boot/dts/econet
#export DTS_FILE=en7581.dts
...
ifneq ($(strip $(TCSUPPORT_CPU_EN7551)),)
export TCSUPPORT_CPU_EN7551=1
BSP_CFLAGS+= -DTCSUPPORT_CPU_EN7551
endif
...
#export TCSUPPORT_PWR_SENSOR=1
export CONFIG_USE_MT7520_ASIC=1
#ifneq ($(strip $(TCSUPPORT_KERNEL_UPSTREAM)),)
#export DTB_FILE=en7523_evb.dtb
#else
#export DTB_FILE=en7523.dtb
#endif
#export DTB_WRT_FILE=en7523_evb.dtb


#export DTB_PATH=$(KERNEL_DIR)/arch/arm/boot/dts
#export DTS_FILE=en7523.dts
...
ifneq ($(strip $(TCSUPPORT_SWITCH_8850)),)
export TCSUPPORT_SWITCH_8850=1
BSP_CFLAGS+= -DTCSUPPORT_SWITCH_8850
endif
ifneq ($(strip $(TCSUPPORT_SWITCH_8851)),)
export TCSUPPORT_SWITCH_8851=1
BSP_CFLAGS+= -DTCSUPPORT_SWITCH_8851
...
#endif for TCSUPPORT_CPU_EN7581
endif
#endif for TCSUPPORT_CPU_AN7583
endif
#endif for TCSUPPORT_CPU_EN7552
...
#KERNEL_CONF=kernel_5_10.config
export TCSUPPORT_5_10_KERNEL=1
export TCSUPPORT_KERNEL_VERSION=510146
BSP_CFLAGS+=-DTCSUPPORT_5_10_KERNEL
endif

ifneq ($(strip $(TCSUPPORT_6_6_KERNEL)),)
KERNEL_CONF=kernel_6_6.config
export TCSUPPORT_6_6_KERNEL=1
export TCSUPPORT_KERNEL_VERSION=606023
BSP_CFLAGS+=-DTCSUPPORT_6_6_KERNEL
endif
...
#ifneq ($(strip $(KERNEL_ECNT_INC_DIR)),)
#BSP_CFLAGS+=-I$(KERNEL_ECNT_INC_DIR)
#endif
#ifneq ($(strip $(KERNEL_DIR)),)
#BSP_CFLAGS+=-I$(KERNEL_DIR)/drivers/mtd/ralink
#endif
else
ifneq ($(strip $(KERNEL_ECNT_DIR)),)
ifneq ($(strip $(RDKB_BUILD)),)
BSP_CFLAGS+=-I$(TRUNK_DIR)/bootloader/ATF/arm-trusted-firmware-2.3/drivers/mtd/econet
else
...
#ifneq ($(strip $(TCSUPPORT_EMMC_BLOCK)),)
#export TCSUPPORT_EMMC_BLOCK
#BSP_CFLAGS+=-DTCSUPPORT_EMMC_BLOCK
#endif
...
#  -DTCSUPPORT_YAFFS_FS
BSP_CFLAGS+=-DTCSUPPORT_SQUASHFS_ADD_YAFFS
endif
...
ifneq ($(strip $(TCSUPPORT_WLAN_MULTI_CHIP)),)
BSP_CFLAGS+=-DBBUTOWBU -DTCSUPPORT_DUAL_WLAN -DTCSUPPORT_WLAN_AC 
export TCSUPPORT_WLAN_AC=1
export TCSUPPORT_WLAN_MULTI_CHIP=1
BSP_CFLAGS+=-DTCSUPPORT_WLAN_MULTI_CHIP
endif
...
ifneq ($(strip $(TCSUPPORT_WLAN_SW_BLOCK_TX)),)
export TCSUPPORT_WLAN_SW_BLOCK_TX
BSP_CFLAGS+=-DTCSUPPORT_WLAN_SW_BLOCK_TX
endif

ifneq ($(strip $(TCSUPPORT_WIRELESS_MODE_ENTRY)),)
export TCSUPPORT_WIRELESS_MODE_ENTRY
BSP_CFLAGS+=-DTCSUPPORT_WIRELESS_MODE_ENTRY
endif
...
ifneq ($(strip $(TCSUPPORT_WLAN_MULTI_CHIP)),1)
...
BSP_CFLAGS+=-DMT7993 -DTCSUPPORT_WLAN_MT7993 -DTCSUPPORT_DUAL_WLAN -DTCSUPPORT_WLAN_AC -DTCSUPPORT_WLAN_AX -DTCSUPPORT_WLAN_WPA3
export TCSUPPORT_WLAN_MT7993
export TCSUPPORT_WLAN_AC=1
endif
...
ifneq ($(strip $(TCSUPPORT_WLAN_MT76_MP23)),)
BSP_CFLAGS+=-DTCSUPPORT_WLAN_MT76_MP23 -DMT76_MP23
export TCSUPPORT_WLAN_MT76_MP23=1
endif
...
ifneq ($(strip $(TCSUPPORT_WLAN_UNION_ITF)),)
BSP_CFLAGS+=-DTCSUPPORT_WLAN_UNION_ITF
export TCSUPPORT_WLAN_UNION_ITF=1
endif
ifneq ($(strip $(TCSUPPORT_WLAN_MULTI_CHIP)),1)
...
ifneq ($(strip $(TCSUPPORT_PCIE_MSI)),)
BSP_CFLAGS+=-DTCSUPPORT_PCIE_MSI
export TCSUPPORT_PCIE_MSI
endif
ifneq ($(strip $(TCSUPPORT_WLAN_MULTI_CHIP)),1)
...
BSP_CFLAGS+=-DTCSUPPORT_RA_HWNAT
ifneq ($(strip $(MODULES_RA_HWNAT_DIR)),)
BSP_CFLAGS+=-I$(MODULES_RA_HWNAT_DIR)
endif
else
ifeq ($(strip $(TCSUPPORT_HWNAT_V3)),)
BSP_CFLAGS+=-DTCSUPPORT_RA_HWNAT
ifneq ($(strip $(MODULES_RA_HWNAT_7510_DIR)),)
BSP_CFLAGS+=-I$(MODULES_RA_HWNAT_7510_DIR)
endif
endif
endif
...
BSP_CFLAGS+=-DTCSUPPORT_VOIP_LED_APPCTRL
#endif
ifneq ($(strip $(TCSUPPORT_VOIP_PCM_SEP)),)
export TCSUPPORT_VOIP_PCM_SEP=1
BSP_CFLAGS+= -DTCSUPPORT_VOIP_PCM_SEP
endif
...
export VOIP_MAX_CHAN
BSP_CFLAGS+=-DVOIP_MAX_CHAN=$(VOIP_MAX_CHAN)
else
BSP_CFLAGS+=-DVOIP_MAX_CHAN=2
endif
ifneq ($(strip $(TCSUPPORT_VOIP_SRTP)),)
export TCSUPPORT_VOIP_SRTP=1
BSP_CFLAGS+=-DTCSUPPORT_VOIP_SRTP
endif
ifneq ($(strip $(TCSUPPORT_VOIP_RTCP_XR)),)
export TCSUPPORT_VOIP_RTCP_XR=1
BSP_CFLAGS+=-DTCSUPPORT_VOIP_RTCP_XR
endif
...
ifneq ($(strip $(TCSUPPORT_VOIP_GPIO_INT)),)
export TCSUPPORT_VOIP_GPIO_INT=1
BSP_CFLAGS+=-DTCSUPPORT_VOIP_GPIO_INT
endif
#### from apps_rule.mak
endif
...
ifneq ($(strip $(TCSUPPORT_ACCOUNT_METER_V2)),)
export TCSUPPORT_ACCOUNT_METER_V2
BSP_CFLAGS+=-DTCSUPPORT_ACCOUNT_METER_V2
endif

ifneq ($(strip $(TCSUPPORT_HIERARCHICAL_METER)),)
export TCSUPPORT_HIERARCHICAL_METER
BSP_CFLAGS+=-DTCSUPPORT_HIERARCHICAL_METER
endif
...
ifneq ($(strip $(TCSUPPORT_SISM)),)
export TCSUPPORT_SISM=1
BSP_CFLAGS+=-DTCSUPPORT_SISM
ifneq ($(strip $(TCSUPPORT_SISM_HOST)),)
export TCSUPPORT_SISM_HOST=1
BSP_CFLAGS+=-DTCSUPPORT_SISM_HOST
export TCSUPPORT_HOST_SERVICE_MANAGER=1
BSP_CFLAGS+=-DTCSUPPORT_HOST_SERVICE_MANAGER
else
export TCSUPPORT_CLIENT_SERVICE_MANAGER=1
BSP_CFLAGS+=-DTCSUPPORT_CLIENT_SERVICE_MANAGER
endif
endif
...
BSP_PKG_CFLAGS+=-DTCSUPPORT_ORN_EBTABLES
endif
...
BSP_CFLAGS+=-DTCSUPPORT_RESERVEAREA_BLOCK=$(TCSUPPORT_RESERVEAREA_BLOCK)
export TCSUPPORT_RESERVEAREA_BLOCK
endif
endif
...
ifneq ($(strip $(TCSUPPORT_PROLINECMD_NG)),)
export TCSUPPORT_PROLINECMD_NG=1
BSP_CFLAGS+=-DTCSUPPORT_PROLINECMD_NG
endif
...
ifneq ($(strip $(TCSUPPORT_CT_JOYME4_JC)),)
export TCSUPPORT_CT_JOYME4_JC=1
BSP_CFLAGS+=-DTCSUPPORT_CT_JOYME4_JC
endif
...
ifneq ($(strip $(TCSUPPORT_OLT)),)
export TCSUPPORT_OLT=1
BSP_CFLAGS+=-DTCSUPPORT_OLT
endif
...
ifneq ($(strip $(TCSUPPORT_PON_CF)),)
export TCSUPPORT_PON_CF=1
BSP_CFLAGS+=-DTCSUPPORT_PON_CF
endif
...
ifneq ($(strip $(TCSUPPORT_AN8901)),)
export TCSUPPORT_AN8901=1
BSP_CFLAGS+=-DTCSUPPORT_AN8901
endif
...
ifneq ($(strip $(TCSUPPORT_CT_PON_CF)),)
export TCSUPPORT_CT_PON_CF=1
BSP_CFLAGS+=-DTCSUPPORT_CT_PON_CF
endif

ifneq ($(strip $(TCSUPPORT_BL2_OPTIMIZATION)),)
export TCSUPPORT_BL2_OPTIMIZATION=1
BSP_CFLAGS+=-DTCSUPPORT_BL2_OPTIMIZATION
endif

ifneq ($(strip $(TCSUPPORT_LOW_DDR_FREQ)),)
export TCSUPPORT_LOW_DDR_FREQ=1
BSP_CFLAGS+=-DTCSUPPORT_LOW_DDR_FREQ
endif

ifneq ($(strip $(TCSUPPORT_DUAL_KEY)),)
export TCSUPPORT_DUAL_KEY=1
BSP_CFLAGS+=-DTCSUPPORT_DUAL_KEY
endif

ifneq ($(strip $(TCSUPPORT_ARM_MULTIBOOT)),)
export TCSUPPORT_ARM_MULTIBOOT=1
BSP_CFLAGS+=-DTCSUPPORT_ARM_MULTIBOOT
endif
...
ifneq ($(strip $(TCSUPPORT_CHIP_VARIANT_CFG)),)
export TCSUPPORT_CHIP_VARIANT_CFG=1
BSP_CFLAGS+=-DTCSUPPORT_CHIP_VARIANT_CFG
endif
...
ifneq ($(strip $(TCSUPPORT_IS_CF_PON)),)
export TCSUPPORT_IS_CF_PON=1
BSP_CFLAGS+=-DTCSUPPORT_IS_CF_PON
endif

ifneq ($(strip $(TCSUPPORT_CF_ENV)),)
export TCSUPPORT_CF_ENV=1
BSP_CFLAGS+=-DTCSUPPORT_CF_ENV
endif
...
ifneq ($(strip $(TCSUPPORT_CF_UNIFIED_PLATFORM)),)
export TCSUPPORT_CF_UNIFIED_PLATFORM=1
BSP_CFLAGS+=-DTCSUPPORT_CF_UNIFIED_PLATFORM
endif
...
ifneq ($(strip $(TCSUPPORT_CF_FDB_VLAN)),)
export TCSUPPORT_CF_FDB_VLAN=1
BSP_CFLAGS+=-DTCSUPPORT_CF_FDB_VLAN
endif
...
ifneq ($(strip $(TCSUPPORT_CF_JOYMEV2_PON)),)
export TCSUPPORT_CF_JOYMEV2_PON=1
BSP_CFLAGS+=-DTCSUPPORT_CF_JOYMEV2_PON
endif
...
ifneq ($(strip $(TCSUPPORT_TR471_NPU_OFFLOAD)),)
export TCSUPPORT_TR471_NPU_OFFLOAD=1
BSP_CFLAGS+= -DTCSUPPORT_TR471_NPU_OFFLOAD
endif
...
ifneq ($(strip $(TCSUPPORT_MEMORY_SHRINK_ENHANCE)),)
export TCSUPPORT_MEMORY_SHRINK_ENHANCE=1
BSP_CFLAGS+=-DTCSUPPORT_MEMORY_SHRINK_ENHANCE
endif

ifneq ($(strip $(TCSUPPORT_MEMORY_SHRINK_V2)),)
export TCSUPPORT_MEMORY_SHRINK_V2=1
BSP_CFLAGS+=-DTCSUPPORT_MEMORY_SHRINK_V2
endif
...
BSP_CFLAGS+=-DTCSUPPORT_PPTP_VPN_HWNAT
endif
...
ifneq ($(strip $(TCSUPPORT_MTD_PARTITION_NUM)),)
export TCSUPPORT_MTD_PARTITION_NUM
endif
...
ifneq ($(strip $(TCSUPPORT_MAP_R2_RELEASE_OPEN)),)
export TCSUPPORT_MAP_R2_RELEASE_OPEN=1
BSP_CFLAGS+=-DTCSUPPORT_MAP_R2_RELEASE_OPEN
endif
endif
ifneq ($(strip $(TCSUPPORT_WIFI7_MAP_R6)),)
export TCSUPPORT_WIFI7_MAP_R6=1
BSP_CFLAGS+=-DTCSUPPORT_WIFI7_MAP_R6
endif
endif
...
ifneq ($(strip $(TCSUPPORT_CTC_FTTR_MAIN)),)
export TCSUPPORT_CTC_FTTR_MAIN=1
BSP_CFLAGS+=-DTCSUPPORT_CTC_FTTR_MAIN
endif

ifneq ($(strip $(TCSUPPORT_CTC_FTTR_SUB)),)
export TCSUPPORT_CTC_FTTR_SUB=1
BSP_CFLAGS+=-DTCSUPPORT_CTC_FTTR_SUB
endif

ifneq ($(strip $(TCSUPPORT_CT_APPROUTE)),)
export TCSUPPORT_CT_APPROUTE=1
BSP_CFLAGS+=-DTCSUPPORT_CT_APPROUTE
endif

ifneq ($(strip $(TCSUPPORT_CT_APPFILTER)),)
export TCSUPPORT_CT_APPFILTER=1
BSP_CFLAGS+=-DTCSUPPORT_CT_APPFILTER
endif
...
ifneq ($(strip $(TCSUPPORT_LXC_MGR)),)
export TCSUPPORT_LXC_MGR=1
BSP_CFLAGS+=-DTCSUPPORT_LXC_MGR
endif
...
ifneq ($(strip $(TCSUPPORT_LRO_FOR_SAMBA)),)
export TCSUPPORT_LRO_FOR_SAMBA=1
BSP_CFLAGS+= -DTCSUPPORT_LRO_FOR_SAMBA
endif
...
export TCSUPPORT_UBOOT_MAJOR_VERSION=2014
export TCSUPPORT_UBOOT_VERSION=u-boot-2014.04-rc1
else
ifneq ($(strip $(TCSUPPORT_UBOOT_2023)),)
export TCSUPPORT_UBOOT_MAJOR_VERSION=2023
export TCSUPPORT_UBOOT_VERSION=u-boot-2023.04
...
export TCSUPPORT_ARM_SECURE_BOOT_FW_ENC=1
BSP_CFLAGS+=-DTCSUPPORT_ARM_SECURE_BOOT_FW_ENC
endif
...
ifneq ($(strip $(TCSUPPORT_ARM_SECURE_BOOT_FLASH_KEY)),)
export TCSUPPORT_ARM_SECURE_BOOT_FLASH_KEY=1
BSP_CFLAGS+=-DTCSUPPORT_ARM_SECURE_BOOT_FLASH_KEY
endif
...
export MT7510_EN7512_FPGA_STAGE=1
BSP_CFLAGS+=-DMT7510_EN7512_FPGA_STAGE
endif

ifneq ($(strip $(TCSUPPORT_CPU_EN7581)),)
ifneq ($(strip $(TCSUPPORT_WLAN_INODE)),)
export TCSUPPORT_WLAN_INODE=1
BSP_CFLAGS+= -DTCSUPPORT_WLAN_INODE
endif
endif
...
ifneq ($(strip $(TCSUPPORT_CPU_EN7581)),)
export TCSUPPORT_NPU_V2=1
BSP_CFLAGS+= -DTCSUPPORT_NPU_V2
endif
ifneq ($(strip $(TCSUPPORT_CPU_AN7552)),)
export TCSUPPORT_NPU_V2=1
BSP_CFLAGS+= -DTCSUPPORT_NPU_V2
export TCSUPPORT_NPU_V2_S=1
BSP_CFLAGS+= -DTCSUPPORT_NPU_V2_S
endif
ifneq ($(strip $(TCSUPPORT_CPU_AN7583)),)
export TCSUPPORT_NPU_V2_P=1
BSP_CFLAGS+= -DTCSUPPORT_NPU_V2_P
endif
ifneq ($(strip $(TCSUPPORT_NPU_WIFI_OFFLOAD)),)
export TCSUPPORT_NPU_WIFI_OFFLOAD=1
BSP_CFLAGS+= -DTCSUPPORT_NPU_WIFI_OFFLOAD
ifneq ($(strip $(TCSUPPORT_NPU_V2)),)
export TCSUPPORT_NPU_WIFI_TDMA_OFFLOAD=1
BSP_CFLAGS+= -DTCSUPPORT_NPU_WIFI_TDMA_OFFLOAD
ifneq ($(strip $(TCSUPPORT_WLAN_MT7990)),)
export TCSUPPORT_WLAN_MT7990=1
BSP_CFLAGS+= -DTCSUPPORT_WLAN_MT7990
endif
ifneq ($(strip $(TCSUPPORT_WLAN_MT7992)),)
export TCSUPPORT_WLAN_MT7992=1
BSP_CFLAGS+= -DTCSUPPORT_WLAN_MT7992
endif
ifneq ($(strip $(TCSUPPORT_WLAN_MT7993)),)
export TCSUPPORT_WLAN_MT7993=1
BSP_CFLAGS+= -DTCSUPPORT_WLAN_MT7993
endif
else
export TCSUPPORT_NPU_QDMA=1
BSP_CFLAGS+= -DTCSUPPORT_NPU_QDMA
endif
ifneq ($(strip $(TCSUPPORT_NPU_WIFI_TX)),)
export TCSUPPORT_NPU_WIFI_TX=1
BSP_CFLAGS+= -DTCSUPPORT_NPU_WIFI_TX
endif
endif
...
#export HOST_ADAPTER_TEST_CODE=1
#export NPU_CODE_IN_SRAM=1
#BSP_CFLAGS+= -DNPU_CODE_IN_SRAM
#export NPU_BMGR_TEST=1
#BSP_CFLAGS+= -DNPU_BMGR_TEST
endif

ifneq ($(strip $(TCSUPPORT_GUI_UTF8)),)
export TCSUPPORT_GUI_UTF8=1
BSP_CFLAGS+=-DTCSUPPORT_GUI_UTF8
endif

ifneq ($(strip $(TCSUPPORT_LANMGR_NG)),)
export TCSUPPORT_LANMGR_NG=1
BSP_CFLAGS+=-DTCSUPPORT_LANMGR_NG
endif

ifneq ($(strip $(TCSUPPORT_NP_FTTR)),)
export TCSUPPORT_NP_FTTR=1
BSP_CFLAGS+=-DTCSUPPORT_NP_FTTR
endif

ifneq ($(strip $(TCSUPPORT_MAP_FTTR)),)
export TCSUPPORT_MAP_FTTR=1
BSP_CFLAGS+=-DTCSUPPORT_MAP_FTTR
endif

ifneq ($(strip $(TCSUPPORT_MAP_TURNKEY_MODE)),)
export TCSUPPORT_MAP_TURNKEY_MODE=1
BSP_CFLAGS+=-DTCSUPPORT_MAP_TURNKEY_MODE
endif

ifneq ($(strip $(TCSUPPORT_TEST_STRESS_NG)),)
export TCSUPPORT_TEST_STRESS_NG=1
BSP_CFLAGS+=-DTCSUPPORT_TEST_STRESS_NG
endif

ifneq ($(strip $(TCSUPPORT_TEST_STRESS_NG_V01310)),)
export TCSUPPORT_TEST_STRESS_NG_V01310=1
BSP_CFLAGS+=-DTCSUPPORT_TEST_STRESS_NG_V01310
endif

ifneq ($(strip $(TCSUPPORT_ETHER_8811)),)
export TCSUPPORT_ETHER_8811=1
BSP_CFLAGS+= -DTCSUPPORT_ETHER_8811
endif

ifneq ($(strip $(TCSUPPORT_ETHER_8831)),)
export TCSUPPORT_ETHER_8831=1
BSP_CFLAGS+= -DTCSUPPORT_ETHER_8831
endif

ifneq ($(strip $(TCSUPPORT_USE_DSA)),)
export TCSUPPORT_USE_DSA=1
BSP_CFLAGS+= -DTCSUPPORT_USE_DSA
endif

ifneq ($(strip $(TCSUPPORT_KERNEL_API)),)
export TCSUPPORT_KERNEL_API=1
BSP_CFLAGS+= -DTCSUPPORT_KERNEL_API
endif

ifneq ($(strip $(TCSUPPORT_COMBO_PON)),)
export TCSUPPORT_COMBO_PON=1
BSP_CFLAGS+= -DTCSUPPORT_COMBO_PON
endif
ifneq ($(strip $(TCSUPPORT_CT_WIFI7)),)
export TCSUPPORT_CT_WIFI7=1
BSP_CFLAGS+= -DTCSUPPORT_CT_WIFI7
endif
export TCSUPPORT_BLAPI=1
BSP_CFLAGS+=-DTCSUPPORT_BLAPI

# export TCSUPPORT_BUSYBOX_1_26_2=1
export UBOOT_CLFAGS:=$(BSP_CFLAGS)

BSP_CFLAGS+=$(WARNING_CTRL_FLAGS)

ifneq ($(strip $(ARHT_SECURE_CFLAGS)),)
export ARHT_SECURE_OBJ_FLAGS= -fPIC
export ARHT_SECURE_APP_FLAGS= -fPIC -fPIE -pie -Wl,-z,relro,-z,now
export ARHT_SECURE_SO_FLAGS = -fPIC -fPIE -Wl,-z,relro,-z,now
endif

ifneq ($(strip $(TCSUPPORT_CF)),)
export TCSUPPORT_CF=1
BSP_CFLAGS+=-DTCSUPPORT_CF
endif
...
export BSP_EXT_CFLAGS=-I$(BSP_EXT_INC)
...
ifneq ($(strip $(TCSUPPORT_IOPSYS_DISABLE_IPV6_DEV_CONFIG_ECNT_HOOK)),)
export TCSUPPORT_IOPSYS_DISABLE_IPV6_DEV_CONFIG_ECNT_HOOK=1
BSP_CFLAGS+=-DTCSUPPORT_IOPSYS_DISABLE_IPV6_DEV_CONFIG_ECNT_HOOK
endif
